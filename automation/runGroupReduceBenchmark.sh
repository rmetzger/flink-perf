...
$FLINK_BUILD_HOME"/bin/flink" run -v -c com.github.projectflink.GroupReduceBenchmarkFlink -p $DOP $TESTJOB_HOME"/flink-jobs/target/flink-jobs-*-SNAPSHOT.jar" foo $DOP 5 hdfs:///datasets/$1 hdfs:///datasets/group-reduce-ouput-k5
